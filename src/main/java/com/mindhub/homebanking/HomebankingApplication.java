...
/*
			...
			Loan loan1 = loanRepository.save(new Loan("Hipotecario", 500000, List.of(12,24,36,48,60),20));
			Loan loan2 = loanRepository.save(new Loan("Personal", 100000, List.of(6,12,24),30));
			Loan loan3 = loanRepository.save(new Loan("Automotriz", 300000, List.of(6,12,24,36),25));
